...
int main(int argc, char **argv) {
    ...
    struct ifreq ethreq;
    strncpy(ethreq.ifr_name, "eth1", IF_NAMESIZE);
...
*/
    ...
    // For sniffing only ICMP packets
    // the filter code is generated by running: tcpdump -i eth1 icmp -dd
    struct sock_filter BPF_code[] = {
        { 0x28, 0, 0, 0x0000000c },
        { 0x15, 0, 3, 0x00000800 },
        { 0x30, 0, 0, 0x00000017 },
